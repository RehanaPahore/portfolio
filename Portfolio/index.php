...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/m.jpg" rel="icon">
    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/m.jpg" class="img-fluid" alt="" style=" width: 80%;">
        </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            ...
            <p><em>I excel in frontend programming with HTML (80%), CSS (70%), and JavaScript (80%), and possess backend proficiency in Java and PHP. Skilled in database management with PostgreSQL and SQL, my portfolio highlights dynamic web development projects alongside graphic design expertise.</em></p>
            <p>
            <ul>
              <li>DADU, SINDH</li>
              <li>rehanapahore@gmail.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            ...
            <h5>2020 - 2023</h5>
            <p><em>FROM MBBS CAMPUS DADU, SINDH</em></p>
             </div>
        </div>
        <div class="col-lg-6">
          ...
          <div class="resume-item">
            ...
            <h5>2022 - 2023</h5>
            <p><em>HEALTHCARE WEBSITE FOR THE DADU CITY.</em></p>
            <p>
            <ul>
              <li>Developed a comprehensive healthcare website catering specifically to the needs of Dadu City.</li>
              <li>Collaborated with stakeholders to understand requirements and ensure the website meets the specific needs of the Dadu City community.</li>
              <li>Implemented responsive design principles to ensure optimal user experience across various devices.</li>
              <li>Contributed to the project's success by combining web development expertise with a deep understanding of healthcare industry requirements.</li>
            </ul>
            </p>
          </div>
          <div class="resume-item">
            ...
            <h5>2017 - 2018</h5>
            <p><em>Stepping Stone Advertising, pakistan</em></p>
            <p>
            <ul>
